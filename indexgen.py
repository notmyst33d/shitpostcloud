...
for file in reversed(files):
    ...
    if file.endswith(".mp4"):
        ...
        content += f"<img loading=\"lazy\" class=\"thumbnail\" src=\"{prefix}thumbs/{quote(file_gif)}\">"
    elif file.endswith(".jpg") or file.endswith(".png") or file.endswith(".jpeg"):
        file_jpg = file.replace(".png", ".jpg").replace(".jpeg", ".jpg")
        content += f"<img loading=\"lazy\" class=\"thumbnail\" src=\"{prefix}thumbs/{quote(file_jpg)}\">"
    content += "</a>"
